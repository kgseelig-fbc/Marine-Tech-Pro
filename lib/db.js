...
try { db.exec(`ALTER TABLE feedback ADD COLUMN resolved_at INTEGER`); } catch (_) {}
try { db.exec(`ALTER TABLE feedback ADD COLUMN is_known_issue INTEGER NOT NULL DEFAULT 0`); } catch (_) {}
