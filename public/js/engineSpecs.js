...
window.engineSpecDatabase = [
...

    {
        ...
        fuelSystem: "EFI — multi-port (port injection), supercharged with charge-air cooling",
        ignition: "Coil-on-plug (individual coils)",
        ...
        fuelPressure: "Low pressure (lift pump): 39–43 PSI | Rail pressure: verify with CDS G3 for the serial number",
        injectorResistance: "Verify with CDS G3 / service manual for the serial number",
    ...
    {
        name: "Yamaha F115C / LF115C (2003–2013, legacy)",
        manufacturer: "Yamaha",
        years: "2003–2013 (F115C/LF115C platform — legacy; NOT the 2014+ 1.8L F115). Factory service manual: Yamaha 68V-28197-1F-11.",
        yearsShort: "2003–2013",
        legacy: true,
        ...
        compressionMin: "931 kPa (9.5 kgf/cm², 135 PSI) at WOT, 68°F, plugs removed",
        compressionVariation: "Within 10% across all cylinders",
        ...
        oilPressureIdle: "343 kPa (49.8 PSI) @ idle, 55°C (factory reference)",
        ...
        overheatAlarm: "Fail-safe / warning control on overheat; flash code 15 = cooling water temperature sensor signal. The F115C 68V code chart has NO code 46 — thermoswitch code 46 exists only on the F150TR / F200 V6 charts.",
        ...
        notes: [
            ...
            "• Timing belt tensioner (M10): 40 Nm. Drive sprocket (M40): 265 Nm (192 ft-lb).",
            "• Ring nut (M101.5): 105 Nm (76 ft-lb). Impeller housing (M8): 18 Nm.",
...

    {
        ...
        injectorResistance: "Typical — verify with YDS: 11.6–12.4 ohms at 68°F",
        compressionNormal: "Typical — verify with YDS: 185–213 PSI",
        compressionMin: "Typical — verify with YDS: 171 PSI (do not condemn an engine against this generic figure without the YDS / service-manual minimum for the serial number)",
        compressionVariation: "Within 10%",
        oilType: "Yamalube 4M 10W-30 (FC-W rated)",
        oilCapacity: "3.7 quarts with filter",
        oilPressureIdle: "Typical — verify with YDS: 14+ PSI",
        oilPressureWOT: "Typical — verify with YDS: 43–71 PSI",
        thermostatOpens: "140°F (60°C)",
        normalTemp: "140–176°F",
        overheatAlarm: "Typical — verify with YDS: ECM overheat limit ~95 °C / 203 °F; thermoswitch trip point per the factory spec for your part number",
        chargingType: "Permanent magnet stator + rectifier/regulator",
        chargingOutput: "28A",
        chargingVoltage: "13.8–14.8V",
        gearOilCapacity: "14.1 oz (verify per HIN / owner's manual before filling)",
        gearOilType: "Yamalube Marine Gear Oil",
        notes: [
            "This entry covers the 2014+ F115 platform (1.8L, 16-valve DOHC).",
            "For the earlier F115C / LF115C (2003–2013, 1.74L), see the 'Yamaha F115C / LF115C (2003–2013, legacy)' entry."
        ],
        maintenance: [
            {
                interval: "Initial — 20 Hours",
    ...
    {
        name: "Yamaha F150TR / LF150TR (63P, legacy)",
        manufacturer: "Yamaha",
        years: "F150TR / LF150TR 63P-series (mid-2000s to early-2010s) — legacy entry; the same 2670 cc block continues in the current F150. Factory service manual: Yamaha 63P1F11.",
        yearsShort: "mid-2000s–early 2010s",
        legacy: true,
        cylinders: "4 (Inline) — DOHC 16V",
...

    {
        ...
        sparkTorque: "13 lb-ft",
        fuelPressure: "36–44 PSI",
        injectorResistance: "Typical — verify with YDS: 11.6–12.4 ohms at 68°F (F150TR factory figure for this block: 14.0–15.0 Ω @ 20°C)",
        compressionNormal: "Typical — verify with YDS: 185–213 PSI",
        compressionMin: "880 kPa (128 PSI) at WOT, 68°F, plugs removed — factory minimum for the 2670 cc F150 block (same as the F150TR); do not condemn an engine against a higher generic figure",
        compressionVariation: "Within 10%",
        oilType: "Yamalube 4M 10W-30 (FC-W rated)",
        oilCapacity: "5.4 L (5.7 US qt) with filter; 5.2 L without — factory figure for the 2670 cc F150 block",
        oilPressureIdle: "Typical — verify with YDS: 14+ PSI (F150TR factory reference for this block: 450 kPa (65.3 PSI) at idle)",
        oilPressureWOT: "Typical — verify with YDS: 43–71 PSI",
        thermostatOpens: "140°F (60°C)",
        normalTemp: "140–176°F",
        overheatAlarm: "Typical — verify with YDS: ECM overheat limit ~95 °C / 203 °F; thermoswitch trip point per the factory spec for your part number",
        ...
        chargingOutput: "40A",
        chargingVoltage: "13.8–14.8V",
        gearOilCapacity: "980 cc / 33.1 US oz (regular rotation); 870 cc / 29.4 US oz (counter-rotation) — factory figures for the F150TR lower unit; verify per HIN",
        gearOilType: "Yamalube Marine Gear Oil",
        notes: [
            "This entry covers the 2019+ F150 current platform.",
            "For the earlier F150TR / LF150TR (63P series, 2000s-era), see the 'Yamaha F150TR / LF150TR (63P, legacy)' entry — same 2670 cc block, so its factory compression minimum, oil capacity and gear-oil capacity are used here.",
    ...
    {
        name: "Yamaha F200/F225 V6 3.3L (69J, legacy)",
        manufacturer: "Yamaha",
        years: "F200TR / LF200TR / F225TR / LF225TR (69J series, legacy 3.3L V6 platform). The current 2.8L inline-4 F200 is a different engine and is NOT covered by this entry.",
        yearsShort: "69J series, pre-2014",
        legacy: true,
        ...
        gearOilType: "Yamaha GEAR CASE LUBE, SAE 90",
        notes: [
            "LEGACY ENTRY — 3.3L V6 F200TR / F225TR (69J) only. The current 2.8L inline-4 F200 is NOT covered by this entry: use the factory manual for that engine or Ask-a-Tech, and do not apply these V6 numbers (6 coils, 128 PSI floor, 6.0 L oil, 38.9 oz gear oil, 2 thermostats) to an inline-4.",
            ...
            "• Self-diagnosis via diagnostic flash indicator (test lead YB-06795) — same code chart as F150 (63P). The F115C 68V chart differs (no code 46; 28 = shift position, 37 = intake air leakage).",
...

    {
        ...
        injectorResistance: "Typical — verify with YDS: 11.6–12.4 ohms at 68°F",
        compressionNormal: "Typical — verify with YDS: 185–213 PSI",
        compressionMin: "Typical — verify with YDS: 170 PSI (do not condemn an engine against this generic figure without the YDS / service-manual minimum for the serial number)",
        compressionVariation: "Within 10%",
        oilType: "Yamalube 4M 10W-30 (FC-W rated)",
